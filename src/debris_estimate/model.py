...
class StagedModel:
    def __init__(self, config: ModelConfig):
        ...
        self.zero_pos_classifier: XGBClassifier = None
        self.tier_classifier: XGBClassifier = None
        self.low_regressor: XGBRegressor = None
        self.high_regressor: XGBRegressor = None
